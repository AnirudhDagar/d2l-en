...
#@tab pytorch
# Initialize as ndarrays, then attach gradients
w, x = torch.tensor([-1.], requires_grad=True), torch.tensor([0.], requires_grad=True) 
y, z = torch.tensor([-2.], requires_grad=True), torch.tensor([1.], requires_grad=True)
...
print(f"df/dw at {w.data.item()}, {x.data.item()}, {y.data.item()}, {z.data.item()} is {y.grad.data.item()}")
print(f"df/dx at {w.data.item()}, {x.data.item()}, {y.data.item()}, {z.data.item()} is {x.grad.data.item()}")
print(f"df/dy at {w.data.item()}, {x.data.item()}, {y.data.item()}, {z.data.item()} is {x.grad.data.item()}")
print(f"df/dz at {w.data.item()}, {x.data.item()}, {y.data.item()}, {z.data.item()} is {x.grad.data.item()}")
```
